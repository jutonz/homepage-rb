Rails.application.routes.draw do
  ...
  resources :galleries do
    scope module: :galleries do
      resource :processing_images, only: :show
      ...
      resources :books do
        resource :read, only: :show, module: :books
      end
    end
  end

  scope(module: :plants) do
    resources(:inbox_images, only: %i[index new create show destroy]) do
      resource(:assignments, only: :create, module: :inbox_images)
    end
    resources(:plants) do
