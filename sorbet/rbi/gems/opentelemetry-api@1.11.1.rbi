...
class OpenTelemetry::Internal::ProxyTracerProvider < ::OpenTelemetry::Trace::TracerProvider
  ...
  #
  # pkg:gem/opentelemetry-api#lib/opentelemetry/internal/proxy_tracer_provider.rb:35
  def initialize; end
  ...
  #
  # pkg:gem/opentelemetry-api#lib/opentelemetry/internal/proxy_tracer_provider.rb:45
  ...
  # @return [Tracer]
  #
  # pkg:gem/opentelemetry-api#lib/opentelemetry/internal/proxy_tracer_provider.rb:74
  def tracer(deprecated_name = T.unsafe(nil), deprecated_version = T.unsafe(nil), name: T.unsafe(nil), version: T.unsafe(nil), attributes: T.unsafe(nil)); end

  private

  # pkg:gem/opentelemetry-api#lib/opentelemetry/internal/proxy_tracer_provider.rb:86
  def supports_attributes?(provider); end
end
...
#
# pkg:gem/opentelemetry-api#lib/opentelemetry/internal/proxy_tracer_provider.rb:21
class OpenTelemetry::Internal::ProxyTracerProvider::LegacyProviderWrapper
  # pkg:gem/opentelemetry-api#lib/opentelemetry/internal/proxy_tracer_provider.rb:22
  def initialize(legacy_provider); end

  # pkg:gem/opentelemetry-api#lib/opentelemetry/internal/proxy_tracer_provider.rb:26
  def tracer(name = T.unsafe(nil), version = T.unsafe(nil), attributes: T.unsafe(nil)); end
end
...
class OpenTelemetry::Trace::Propagation::TraceContext::TraceParent
  # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:122
  ...
  #
  # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:104
  def sampled?; end
  ...
  #
  # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:110
  def to_s; end
  ...
  # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:116
  def flag_string; end
  ...
  class << self
    ...
    #
    # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:38
    ...
    #
    # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:49
    def from_string(string); end

    private

    # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:64
    def match_input(string); end

    # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:100
    def new(*_arg0); end

    # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:93
    def parse_flags(string); end

    # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:86
    def parse_span_id(string); end

    # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:79
    def parse_trace_id(string); end

    # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:71
    def parse_version(string); end
  end
end

# pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:31
OpenTelemetry::Trace::Propagation::TraceContext::TraceParent::INVALID_SPAN_ID = T.let(T.unsafe(nil), String)

# pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:30
...
# pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:18
...
# pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:24
OpenTelemetry::Trace::Propagation::TraceContext::TraceParent::MAX_VERSION = T.let(T.unsafe(nil), Integer)

# pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:27
...
# pkg:gem/opentelemetry-api#lib/opentelemetry/trace/propagation/trace_context/trace_parent.rb:21
...
class OpenTelemetry::Trace::TracerProvider
  ...
  # @return [Tracer]
  #
  # pkg:gem/opentelemetry-api#lib/opentelemetry/trace/tracer_provider.rb:26
  def tracer(deprecated_name = T.unsafe(nil), deprecated_version = T.unsafe(nil), name: T.unsafe(nil), version: T.unsafe(nil), attributes: T.unsafe(nil)); end
end
