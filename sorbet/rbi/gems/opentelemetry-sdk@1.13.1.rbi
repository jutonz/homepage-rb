...
class OpenTelemetry::SDK::Trace::Tracer < ::OpenTelemetry::Trace::Tracer
  ...
  # @return [Tracer]
  #
  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer.rb:23
  def initialize(name, version, tracer_provider, attributes: T.unsafe(nil)); end

  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer.rb:28
  def start_root_span(name, attributes: T.unsafe(nil), links: T.unsafe(nil), start_timestamp: T.unsafe(nil), kind: T.unsafe(nil)); end

  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer.rb:32
...
class OpenTelemetry::SDK::Trace::TracerProvider < ::OpenTelemetry::Trace::TracerProvider
  ...
  #
  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer_provider.rb:32
  ...
  #
  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer_provider.rb:133
  def add_span_processor(span_processor); end
  ...
  #   a non-specific failure occurred, Export::TIMEOUT if a timeout occurred.
  #
  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer_provider.rb:115
  def force_flush(timeout: T.unsafe(nil)); end

  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer_provider.rb:17
  ...
  # @api private
  #
  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer_provider.rb:144
  def internal_start_span(name, kind, attributes, links, start_timestamp, parent_context, instrumentation_scope); end

  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer_provider.rb:18
  def resource; end
  ...
  #   a non-specific failure occurred, Export::TIMEOUT if a timeout occurred.
  #
  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer_provider.rb:85
  def shutdown(timeout: T.unsafe(nil)); end
  ...
  # @return [Tracer]
  #
  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer_provider.rb:62
  ...
  # pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer_provider.rb:187
  def sampler_from_environment(default_sampler); end
end

# pkg:gem/opentelemetry-sdk#lib/opentelemetry/sdk/trace/tracer_provider.rb:13
OpenTelemetry::SDK::Trace::TracerProvider::EMPTY_ATTRIBUTES = T.let(T.unsafe(nil), Hash)
