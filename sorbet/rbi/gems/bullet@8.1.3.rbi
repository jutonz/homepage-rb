...
# pkg:gem/bullet#lib/bullet/active_record81.rb:14
module Bullet::ActiveRecord
  class << self
    # pkg:gem/bullet#lib/bullet/active_record81.rb:15
    def enable; end
  end
end
...
class Bullet::Detector::NPlusOneQuery < ::Bullet::Detector::Association
  ...
  class << self
    # pkg:gem/bullet#lib/bullet/detector/n_plus_one_query.rb:64
    def add_impossible_object(object); end

    # pkg:gem/bullet#lib/bullet/detector/n_plus_one_query.rb:73
    def add_inversed_object(object, association); end

    # pkg:gem/bullet#lib/bullet/detector/n_plus_one_query.rb:40
    def add_possible_objects(object_or_objects); end

    # check if object => associations already exists in object_associations.
    #
    # pkg:gem/bullet#lib/bullet/detector/n_plus_one_query.rb:109
    ...
    def call_association(object, associations, caller_stack = T.unsafe(nil), inversed: T.unsafe(nil)); end

    # decide whether the object.associations is unpreloaded or not.
    #
    # pkg:gem/bullet#lib/bullet/detector/n_plus_one_query.rb:96
    def conditions_met?(object, associations); end

    # pkg:gem/bullet#lib/bullet/detector/n_plus_one_query.rb:104
    def impossible?(object); end

    # pkg:gem/bullet#lib/bullet/detector/n_plus_one_query.rb:100
    def possible?(object); end

    # pkg:gem/bullet#lib/bullet/detector/n_plus_one_query.rb:85
    def update_inversed_object(object); end

    private

    # pkg:gem/bullet#lib/bullet/detector/n_plus_one_query.rb:137
    def create_notification(callers, klazz, associations); end

    # pkg:gem/bullet#lib/bullet/detector/n_plus_one_query.rb:124
    def optional_polymorphic_belongs_to_with_nil_type?(object, associations); end
  end
end
...
class Bullet::Registry::CallStack < ::Bullet::Registry::Base
  ...
  #
  # pkg:gem/bullet#lib/bullet/registry/call_stack.rb:8
  def add(key, backtrace = T.unsafe(nil)); end
end
...
# pkg:gem/bullet#lib/bullet/active_record81.rb:4
module Bullet::SaveWithBulletSupport
  # pkg:gem/bullet#lib/bullet/active_record81.rb:5
