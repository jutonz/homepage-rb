...
# pkg:gem/view_component#lib/view_component/active_job_serializer.rb:6
class ViewComponent::ActiveJobSerializer < ::ActiveJob::Serializers::ObjectSerializer
  # pkg:gem/view_component#lib/view_component/active_job_serializer.rb:19
  def deserialize(hash); end

  # pkg:gem/view_component#lib/view_component/active_job_serializer.rb:7
  def klass; end

  # pkg:gem/view_component#lib/view_component/active_job_serializer.rb:15
  def serialize(proxy); end

  # pkg:gem/view_component#lib/view_component/active_job_serializer.rb:11
