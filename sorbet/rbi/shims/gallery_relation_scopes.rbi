...
# `Gallery` defines `visible` and `hidden` as plain `def self.` class
# methods, not as `scope` macros. Tapioca projects only the macro form
# onto the relation types. A chain such as
