...
RSpec.describe Galleries::Books::ReadPolicy do
  permissions :show? do
  ...
  describe ".scope_for" do
    it "returns only books from galleries belonging to user" do
      ...
      expect(policy_scope).to contain_exactly(user_book1, user_book2)
    end
